...
public class ObatAnak extends AppCompatActivity {
...
//    }
    ...
    private void prepareAlbums() {
        ...
        Paket a = new Paket("Personal",  500000, covers[0],"Beli","Detail");
        paketList.add(a);

        a = new Paket("Couple",  200000, covers[1],"Beli","Detail");
        paketList.add(a);

        a = new Paket("Maturity",  150000, covers[2],"Beli","Detail");
        paketList.add(a);

        a = new Paket("Group",  155000, covers[3],"Beli","Detail");
        paketList.add(a);

        a = new Paket("PreWeed",160000, covers[4],"Beli","Detail");
        paketList.add(a);

        a = new Paket("Wisuda",145000, covers[5],"Beli","Detail");
        paketList.add(a);

        a = new Paket("Weeding",135000, covers[6],"Beli","Detail");
        paketList.add(a);
