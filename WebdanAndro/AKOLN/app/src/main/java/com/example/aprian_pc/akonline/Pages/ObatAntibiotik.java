...
import com.example.aprian_pc.akonline.TabAntibiotik.AntibiotikAdapter;
...
public class ObatAntibiotik extends AppCompatActivity {
    ...
    private AntibiotikAdapter adapter;
    private List<Antibiotik> paketList;
    private ProgressDialog pd;
    final String URL = ServerUrl.URL+"Android/Herbal/get_ObatAntibiotik";
//    private Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AntibiotikAdapter(this, paketList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            JSONArray antibiotik = jsObj.getJSONArray("antibiotik");
                            String beli="beli", detail="detail";
                            Antibiotik obatantibiotik;
                            for (int i=0;i<antibiotik.length();i++){
                                JSONObject p = antibiotik.getJSONObject(i);
                                ...
                                obatantibiotik = new Antibiotik(name,harga,url_gambar, beli,detail,id);
                                paketList.add(obatantibiotik);
                            }
                            adapter.notifyDataSetChanged();
                        }catch (Exception e){
                            e.printStackTrace();
