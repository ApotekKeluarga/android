...
public class HerbalAdapter extends RecyclerView.Adapter<HerbalAdapter.MyViewHolder> {
    ...
    public HerbalAdapter(Context mContext, List<Herbal> paketList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        Herbal paket = paketList.get(position);
        ...
        Log.d("TAG", "onBindViewHolder: "+paket.getThumbnail());
