...
public class ObatHerbal extends AppCompatActivity {
    ...
    private HerbalAdapter adapter;
    private List<Herbal> paketList;
    private ProgressDialog pd;
    final String URL = ServerUrl.URL+"Android/Herbal/get_ObatHerbal";
//    private Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new HerbalAdapter(this, paketList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            JSONArray herbal = jsObj.getJSONArray("herbal");
                            String beli="beli", detail="detail";
                            Herbal obatherbal;
                            for (int i=0;i<herbal.length();i++){
                                JSONObject p = herbal.getJSONObject(i);
                                String name = p.getString("nm_barang");
                                Log.d("ObatHerbal",p.getString("img"));
                                int harga = p.getInt("harga");
                                String id = p.getString("kd_barang");
                                String url_gambar = p.getString("img");
                                obatherbal = new Herbal(name,harga,url_gambar, beli,detail,id);
                                paketList.add(obatherbal);
                            }
                            adapter.notifyDataSetChanged();
                        }catch (Exception e){
                            e.printStackTrace();
