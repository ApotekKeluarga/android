...
import com.example.aprian_pc.akonline.TabAnak.AnakAdapter;
...
public class ObatAnak extends AppCompatActivity {
    ...
    private List<Anak> paketList;
    private ProgressDialog pd;
    final String URL = ServerUrl.URL+"Android/Herbal/get_ObatAnak";
//    private Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AnakAdapter(this, paketList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            JSONArray anak = jsObj.getJSONArray("anak");
                            ...
                            for (int i=0;i<anak.length();i++){
                                ...
                                obatanak = new Anak(name,harga,url_gambar, beli,detail,id);
                                paketList.add(obatanak);
                            }
                            adapter.notifyDataSetChanged();
                        }catch (Exception e){
                            e.printStackTrace();
