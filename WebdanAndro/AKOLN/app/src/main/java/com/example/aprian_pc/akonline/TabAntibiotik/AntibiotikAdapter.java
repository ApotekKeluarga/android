package com.example.aprian_pc.akonline.TabAntibiotik;
...
public class AntibiotikAdapter extends RecyclerView.Adapter<AntibiotikAdapter.MyViewHolder> {
    ...
    public AntibiotikAdapter(Context mContext, List<Antibiotik> paketList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        Antibiotik paket = paketList.get(position);
