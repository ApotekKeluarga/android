package com.example.aprian_pc.akonline.TabAlkes;
...
public class AlkesAdapter extends RecyclerView.Adapter<AlkesAdapter.MyViewHolder> {
    ...
    public AlkesAdapter(Context mContext, List<Alkes> paketList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        Alkes paket = paketList.get(position);
