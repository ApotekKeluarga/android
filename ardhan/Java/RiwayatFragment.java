...
import com.example.aprian_pc.akonline.TabHerbal.Transaksi;
import com.example.aprian_pc.akonline.TabHerbal.TransaksiAdapter;
...
public class RiwayatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        delete = (Button) rootView.findViewById(R.id.delete2);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TransaksiList.size()>0) {
                    TransaksiList.remove(0);
                    adapter.notifyItemRemoved(0);
                }
//                sb = new StringBuffer();
//
//                for (Transaksi t : adapter.checkedTransaksi) {
//                    sb.append(t.getName());
//                    sb.append("\n");
//                }
//
//                if (adapter.checkedTransaksi.size() > 0) {
//                    Toast.makeText(RiwayatFragment.this.getActivity(), sb.toString(), Toast.LENGTH_SHORT).show();
//                } else {
//                    Toast.makeText(RiwayatFragment.this.getActivity(), "Tidak ada item yang dipilih", Toast.LENGTH_SHORT).show();
//                }
            }
        });
